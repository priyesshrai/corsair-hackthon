            ...
            <div className="mx-auto max-w-7xl px-6 py-20 lg:py-28">
                ...
                <div className="mx-auto mt-8 max-w-5xl text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg text-muted">
                        Connect Gmail and Google Calendar once.
                        Then simply ask. Relay schedules meetings,
                        sends emails, updates calendars, and executes
                            ...
                            <div>
                                ...
                                <div className="rounded-2xl border border-line bg-canvas p-5">
                                    <p className="text-sm leading-relaxed">
                                        ...
                                        at 3:00 PM and send her an email
...
function TaskStep({
    ...
    return (
        <div className="flex items-center gap-3 rounded-xl border border-line bg-canvas px-4 py-3">
            <div
                className={`flex h-5 w-5 items-center justify-center rounded-full text-xs ${active
